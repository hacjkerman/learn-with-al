    ...
    <div className="w-full py-12">
      <div className="container flex flex-col gap-6 px-4 text-center md:gap-10 md:flex-row lg:px-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-4">
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-4 flex flex-col items-start dark:border-gray-800 dark:bg-gray-950">
            ...
            <div className="w-full grid grid-cols-1 gap-1 mt-4">
              <div
                ...
                href="#"
              >
                Support dark mode preference in the app
              </div>
